     ...
     const handleFilterChange = async () => {
          try {
               ...
               const response: any = await fetchData({
                    endpoint: `package/public/search?${sortQuery}&category=['religious-tours']`
               });
               ...
               <section className="inner-tours-section">
                    <div className="container">
                         <div className="inner-tour-content">
                              <div className="title">
                                   <h4>Tours : <span>({totalPackages})</span></h4>
                              </div>
                                                                                ...
                                                                                <div className="card-price">
                                                                                     ...
                                                                                     <div className="card-action-btns">
                                                                                          <div className="view-more-btn wo">
                                                                                               <Link href={`${pathName}/${packageInfo?.slug}`} className=""><span>View details</span></Link>
                                                                                          </div>
