        ...
        <>
            <InnerHeaderWithStats
                ...
                breadcrumbs={[
                    ...
                    { label: 'Honeymoon Tours', link: '/honeymoon-tours', class: "" },
                    { label: `${capitalizeText(basePackageName.replace(/-+/g, " "))} Tour Packages`, link: `/honeymoon-tours/${basePackageName}`, class: "self-page" },
                ]}
                stats={[
                    {
